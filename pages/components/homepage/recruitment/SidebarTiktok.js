...
const SidebarTiktok = ({ username, setVisibleSidebar, visibleSidebar }) => {
            ...
            <div className="pl-2 md:pl-3 pr-2 md:pr-3 custom relative">
                <TabView>
                    <TabPanel header="Tiktok" headerTemplate={headerTabTiktok} headerClassName="flex align-items-center header-tabs">
                        <TabTiktok key="TabTiktok" username={username} setVisibleSidebar={setVisibleSidebar} visible={visibleSidebar} />
                    </TabPanel>
                </TabView>
